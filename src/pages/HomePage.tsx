...
export const HomePage = () => {
  return (
    <>
      ...
      <div className="flex flex-row gap-8 justify-between mt-8 max-[768px]:flex-col">
        <CategoryCard
          to="/category/shoes"
          name="Обувь"
          picture="/category-shoes.png"
        />
        <CategoryCard
          to="/category/clothes"
          name="Товары легкой промышл."
          picture="/category-clothes.png"
        />
