					...
					<div className="about__wrapper">
						...
						<div className="right">
							...
							<div className="section__text mb-8">
								<p>
								Для начала вам необходимо быть зарегестрированным в системе 
								Честный Знак <span>"Беларусь" </span>
								а так же получить GLN номер организации
								</p>
							</div>
							<div className="section__stage">
								...
								<p className="stage font-normal mb-8">
								    Для начала нужно во вкладке "Маркировка" заполнить все данные по товару и нажать готово.
								</p>
								...
								<h4 className="flex flex-row text-xl font-medium mb-4 gap-2">
									<img className="w-[24px]" src="images/icons/service/star.png" alt="#" />
									Этап 3: Оприходывание
								</h4>
								<p className="stage font-normal">
							    	После обработки заказа и его подтверждения в течении 3-4 рабочих дней Маркировка поступит к вам в Электронный знак, где вам будет необходимо ее оприходывать для дальнейшей работы
								</p>
							</div>
						</div>
					</div>
