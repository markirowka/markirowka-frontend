          ...
          <div className="about__wrapper">
            ...
            <div className="right">
              ...
              <div className="section__stage">
                ...
                <p className="stage font-normal mb-8">
                  В течении 2-х рабочих дней ваша заявка будет обработана нашими менеджерами 
                ...
                После обработки заказа и его подтверждения втечение 
                3-4 рабочих дней Маркировка поступит к вам в Электронный знак, где вам будет 
                необходимо ее оприходывать для дальнейшей работы
                </p>
              </div>
            </div>
          </div>
